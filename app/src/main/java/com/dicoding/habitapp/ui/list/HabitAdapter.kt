...
class HabitAdapter(
    ...
    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(habit: Habit) {
            ...
            if(habit.priorityLevel == "High") ivPriority.setImageResource(R.drawable.ic_priority_high)
            else if(habit.priorityLevel == "Medium") ivPriority.setImageResource(R.drawable.ic_priority_medium)
